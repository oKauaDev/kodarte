...
export default function ServicesPage() {
  return (
    <>
      <Head>
        <title>Serviços | Kodarte</title>
        <meta
          name="description"
          content="Serviços que oferecemos e como podemos te ajudar a abrir o seu espaço na internet."
        />
      </Head>
        ...
        <main className="flex">
          ...
          <div className="px-[2.81vw] max-mdl:px-[6vw] py-10 mx-auto mt-[15vh] max-mdl:mt-[7.5vh]">
            ...
            <Image
              ...
              width={532}
              height={400}
              alt="Desenvolvimento web, design ui/ux, criação de sites, kodarte"
