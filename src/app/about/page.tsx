        ...
        <div className="px-[2.81vw] max-mdl:px-[6vw] py-10 mx-auto mt-[15vh] max-mdl:mt-[7.5vh]">
          ...
          <h1 className="mt-3 font-bold tracking-widest font-space-grotesk text-[2rem] max-xl:text-2xl text-support-100 uppercase text-center max-w-[791px] mx-auto to-top">
            ...
            <ExplainText
              ...
              explain={
                <>
                  ...
                  arte, criando sites com cuidado, detalhe e paixão, como quem esculpe com pixels e
                  lógica.
                </>
              }
            />{" "}
            ...
            <ExplainText
              ...
              explain={
                <>
                  <span className="font-bold">Cosmovisão</span> é o jeito único de enxergar o mundo
                  — como se cada pessoa usasse óculos diferentes pra entender a vida, o certo, o
                  errado e o tudo.
                </>
              }
            />{" "}
